...
# PSN integration
#gem 'api-psn', git: 'https://github.com/isFakeAccount/api-psn'
...
group :development do
  ...
  # Dump existing database to create seed data files
  gem "seed_dump"
  ...
  # Improve code quality by checking for code smells
  gem "reek"
end
