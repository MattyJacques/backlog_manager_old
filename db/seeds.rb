...
Platform.create!([
  ...
  { name: "Xbox One", igdb_id: 48, platform_family_id: 2 },
...
ReleaseDate.create!([
  { date: Date.new(2020, 9, 4), game_id: 1, platform_id: 2 },
  { date: Date.new(2020, 9, 4), game_id: 1, platform_id: 3 },
  { date: Date.new(2020, 9, 4), game_id: 1, platform_id: 1 },
  { date: Date.new(2021, 3, 18), game_id: 1, platform_id: 4 },
  { date: Date.new(2021, 3, 18), game_id: 1, platform_id: 5 },
  { date: Date.new(2020, 9, 4), game_id: 1, platform_id: 6 },
  { date: Date.new(2020, 9, 4), game_id: 1, platform_id: 5 },
  { date: Date.new(2019, 10, 31), game_id: 2, platform_id: 7 },
  { date: Date.new(2013, 6, 14), game_id: 3, platform_id: 8 },
  { date: Date.new(2013, 6, 14), game_id: 3, platform_id: 8 },
  { date: Date.new(2020, 6, 19), game_id: 4, platform_id: 2 },
  { date: Date.new(2019, 3, 15), game_id: 5, platform_id: 3 },
  { date: Date.new(2019, 3, 15), game_id: 5, platform_id: 2 },
  { date: Date.new(2019, 3, 15), game_id: 5, platform_id: 1 },
  { date: Date.new(2020, 3, 17), game_id: 5, platform_id: 6 },
  { date: Date.new(2020, 12, 1), game_id: 6, platform_id: 4 },
  { date: Date.new(2020, 12, 1), game_id: 6, platform_id: 5 },
  { date: Date.new(2015, 12, 1), game_id: 6, platform_id: 3 },
  { date: Date.new(2015, 12, 1), game_id: 6, platform_id: 2 },
  { date: Date.new(2021, 6, 30), game_id: 6, platform_id: 6 },
  { date: Date.new(2015, 12, 1), game_id: 6, platform_id: 1 },
  { date: Date.new(2017, 9, 6), game_id: 7, platform_id: 2 },
  { date: Date.new(2017, 9, 6), game_id: 7, platform_id: 3 },
  { date: Date.new(2017, 9, 6), game_id: 7, platform_id: 2 },
  { date: Date.new(2017, 9, 6), game_id: 7, platform_id: 2 },
  { date: Date.new(2017, 9, 6), game_id: 7, platform_id: 3 },
  { date: Date.new(2017, 10, 24), game_id: 7, platform_id: 1 },
  { date: Date.new(2020, 12, 8), game_id: 7, platform_id: 4 },
  { date: Date.new(2020, 12, 8), game_id: 7, platform_id: 5 },
  { date: Date.new(2019, 11, 19), game_id: 7, platform_id: 6 },
])
